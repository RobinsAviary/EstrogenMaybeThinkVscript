This is a vscript file used on [cp_estradiol]() for the final point. It is used to set a func_movelinear's position target to the capture percentage of the third point.
